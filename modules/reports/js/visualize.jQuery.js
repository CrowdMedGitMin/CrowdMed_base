                ...
                function scrapeTable(){
                        ...
                        var tableData = {
                                ...
                                topValue: function(){
                                                ...
                                                var allData = this.allData().join(',').split(',');
                                                $(allData).each(function(){
                                                        if(parseFloat(this,10)>topValue) topValue = Math.ceil(parseFloat(this));
                                                });
                                                return topValue;
                                },
                                bottomValue: function(){
                                                ...
                                                var allData = this.allData().join(',').split(',');
                                                $(allData).each(function(){
                                                        if(this<bottomValue) bottomValue = Math.floor(parseFloat(this))-5;
                                                });
                                                return bottomValue;
                                },
                        ...
                        line: function(area){
                                ...
                                $.each(dataGroups,function(h){
                                        ...
                                        $.each(points, function (i,point) {
												if (!isNaN(point)) {
													ctx.lineTo(integer,-(point*yScale));
	                                                integer+=xInterval;
												}
                                        });
